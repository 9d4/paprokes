    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tr v-for="rec in records" v-bind:key="rec.id">
                ...
                <td>@{{ rec['temp'] }}</td>
                <td>@{{ parseTime(rec['time']) }}</td>
                <td>
                    <svg v-if="rec.registered" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check"
                         width="44"
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="44"
